...
public:
    ...
    void update(float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz, float* q) {
        ...
        switch (filter_sel) {
            ...
            case QuatFilterSel::MAHONY:
                ...
                break;
            case QuatFilterSel::MADGWICK_WITHOUT_MAG:
                madgwik_wihout_mag(ax, ay, az, gx, gy, gz, q);
                break;
            default:
    ...
    void madgwik_wihout_mag(float ax, float ay, float az, float gx, float gy, float gz, float* q)
    {
        float recipNorm;
